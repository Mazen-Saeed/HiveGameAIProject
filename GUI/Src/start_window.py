...
class StartWindow(QMainWindow):
    def __init__(self):
        ...
        ui_file = resource_path("UI/start_window.ui")
        ...
        start_window_qss = resource_path("Style/start_window.qss")
        with open(start_window_qss,"r") as file:
    ...
    def load_font_needed(self):
        load_font = resource_path("Fonts/Pridi-Medium.ttf")
